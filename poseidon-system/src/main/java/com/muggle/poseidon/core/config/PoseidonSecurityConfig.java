...
//        web.ignoring().antMatchers("/**/*.jsp", "/**/*.css", "/**/*.js",
//                "/**/*.bmp", "/**/*.gif", "/**/*.png", "/**/*.jpg", "/**/*.ico", "/**/*.html");
////        super.configure(web);
//    }
//
//      @Override
//      protected void configure(HttpSecurity http) throws Exception {
//          http.authorizeRequests().antMatchers("/resources/login.html", "/test/resources/login.html").permitAll()
//                  // user权限可以访问的请求
